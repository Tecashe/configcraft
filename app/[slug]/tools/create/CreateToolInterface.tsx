...
export default function EnhancedCreateToolInterface({ organizationSlug }: CreateToolInterfaceProps) {
  ...
  const handleGenerationUpdate = (update: LiveGenerationUpdate) => {
    switch (update.type) {
      ...
      case "completed":
        if (update.result) {
          console.log("[v0] Generation completed with result:", update.result)
          console.log("[v0] demoUrl from result:", update.result.demoUrl)
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="preview" className="space-y-6 mt-6">
            <div className="space-y-6">
              {/* Preview - Now full width and much taller */}
              <Card className="bg-card border-border">
                <CardHeader>
                  <CardTitle className="text-foreground flex items-center gap-2">
                    <Eye className="h-5 w-5 text-primary" />
                ...
                <CardContent>
                  {generationStatus.demoUrl ? (
                    ...
                    <div className="text-center py-12 text-muted-foreground">
                      ...
                      <p className="text-lg font-medium mb-2">Preview will appear once generation is complete</p>
                      <p className="text-sm">Your generated tool will be displayed here in an interactive preview</p>
                    </div>
                  )}
                </CardContent>
              </Card>

              {/* Files - Now below preview in full width */}
              <Card className="bg-card border-border">
                <CardHeader>
                  <CardTitle className="text-foreground flex items-center gap-2">
                    <FileText className="h-5 w-5 text-accent" />
