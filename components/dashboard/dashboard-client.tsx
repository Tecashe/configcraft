  ...
  return (
    <div className="min-h-screen bg-slate-900 flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        {/* Dashboard Content */}
        <main className="flex-1 p-6 bg-slate-800/20">
          {/* Welcome Section */}
          <div className="mb-8">
            <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 text-white">
              ...
              <Button size="lg" className="bg-slate-700 hover:bg-slate-600 text-white" asChild>
                <Link href={`/${organizationSlug}/tools/create`}>
                  <Plus className="w-5 h-5 mr-2" />
                  Create Your First Tool
                </Link>
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardContent className="p-6">
                ...
                <div className="flex items-center mt-4 text-sm">
                  ...
                  <span className="text-slate-400">{stats.usageThisMonth} this month</span>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="mt-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Link href={`/${organizationSlug}/tools/create`}>
                <Card className="bg-slate-800/50 border-slate-700 hover:bg-slate-800/70 transition-colors cursor-pointer">
                  <CardContent className="p-6 text-center">
                    <div className="w-12 h-12 bg-slate-700 border border-slate-600 rounded-lg flex items-center justify-center mx-auto mb-3">
              ...
              <Link href={`/${organizationSlug}/templates`}>
                <Card className="bg-slate-800/50 border-slate-700 hover:bg-slate-800/70 transition-colors cursor-pointer">
                  <CardContent className="p-6 text-center">
                    <div className="w-12 h-12 bg-slate-700 border border-slate-600 rounded-lg flex items-center justify-center mx-auto mb-3">
                      <Template className="w-6 h-6 text-slate-300" />
                    </div>
                    <h4 className="font-semibold text-white mb-1">Browse Templates</h4>
                    <p className="text-sm text-slate-400">Start from a template</p>
                  </CardContent>
              ...
              <Link href={`/${organizationSlug}/integrations`}>
                <Card className="bg-slate-800/50 border-slate-700 hover:bg-slate-800/70 transition-colors cursor-pointer">
                  <CardContent className="p-6 text-center">
                    <div className="w-12 h-12 bg-slate-700 border border-slate-600 rounded-lg flex items-center justify-center mx-auto mb-3">
                      <Puzzle className="w-6 h-6 text-slate-300" />
                    </div>
                    <h4 className="font-semibold text-white mb-1">Integrations</h4>
                    <p className="text-sm text-slate-400">Connect your tools</p>
                  </CardContent>
