...
// import { Home, Settings, Wrench, FileText, Plug, CreditCard, Plus, ChevronDown, Building2 } from "lucide-react"
...
//       {
//         name: "Dashboard",
//         href: currentOrg ? `/${currentOrg.slug}/dashboard` : "/dashboard",
//         icon: Home,
//       },
//       {
//         name: "Tools",
//         href: currentOrg ? `/${currentOrg.slug}/tools` : "/tools",
//         icon: Wrench,
//       },
//       {
//         name: "Templates",
//         href: currentOrg ? `/${currentOrg.slug}/templates` : "/templates",
//         icon: FileText,
//       },
//       {
//         name: "Integrations",
//         href: currentOrg ? `/${currentOrg.slug}/integrations` : "/integrations",
//         icon: Plug,
//       },
//       {
//         name: "Billing",
//         href: currentOrg ? `/${currentOrg.slug}/billing` : "/billing",
//         icon: CreditCard,
//       },
//       {
//         name: "Settings",
//         href: currentOrg ? `/${currentOrg.slug}/settings` : "/settings",
//         icon: Settings,
//       },
//     ]
...
//                   <Link href={`/${org.slug}/dashboard`} className="flex items-center space-x-2">
